			...
			<div class="col-12 col-sm-6 col-md-4  ">
				<div class="card m-3 ">
					...
					<div class="card-body p-5">
						...
						<p class="card-text"> <i class="far fa-calendar-alt"></i> Ngày khởi hành: <?php echo $rows->ngay_khoi_hanh ?></p>
						<p class="card-text"><i class="far fa-calendar-alt"></i> Ngày về: <?php echo $rows->ngay_ve ?></p>
						<p class="price-box"> <span class="special-price"> <span class="price product-price"> <i class="fas fa-tags"></i> <?php echo number_format($rows->c_price); ?> VNĐ </span> </span> </p>
						<form action="cart/add" method="post" enctype="multipart/form-data" id="product-actions-1168979">
							<a href="index.php?controller=cart&act=add&id=<?php echo $rows->pk_product_id; ?>" class="button" >Đặt ngay</a>
						</form>
					</div>
				</div>
			</div>
