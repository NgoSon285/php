...
class controller_category_product
{
	...
	public function do_edit($id)
	{
		...
		model::execute("update tbl_category_product set c_name='$c_name' where pk_category_product_id=$id");
	...
	{
		$c_name = $_POST["c_name"];
		model::execute("insert into tbl_category_product set c_name='$c_name'");
		//quay tro lai controller category_product
		echo "<script language='javascript'>location.href='admin.php?controller=category_product'</script>";
	}
