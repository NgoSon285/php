...
class controller_product
{
	...
	{
		$c_name = $_POST["c_name"];
		$start_date = $_POST["ngay_khoi_hanh"];
		$end_date = $_POST["ngay_ve"];
		...
		//update ban ghi
		model::execute("update tbl_product set c_name='$c_name',c_description='$c_description',c_content='$c_content',fk_category_product_id=$fk_category_product_id,c_hotproduct=$c_hotproduct, c_price=$c_price,ngay_khoi_hanh ='$start_date',ngay_ve='$end_date' where pk_product_id=$id");
		...
		echo "<script language='javascript'>location.href='admin.php?controller=product'</script>";
	}
	//do_add
	public function do_add()
	{
		...
		model::execute("insert into tbl_product set c_name='$c_name',c_description='$c_description',c_content='$c_content',fk_category_product_id=$fk_category_product_id,c_hotproduct=$c_hotproduct,c_img = '$c_img', c_price=$c_price,ngay_khoi_hanh ='$start_date',ngay_ve='$end_date'");
